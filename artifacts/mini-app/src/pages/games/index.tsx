...
const GAME_CARDS = [
  ...
  },
  {
    ...
    titleRu: "Кейсы",
    titleEn: "Cases",
    descRu: "Ключи боссов и платные кейсы",
    descEn: "Boss keys and paid cases",
    ready: true,
    baseOnline: 22,
    primary: "#A855F7",
    gradient: "linear-gradient(180deg,#9333EA,#581C87)",
...
export default function GamesPage() {
  ...
  return (
    <div style={{ padding: "72px 16px 32px", background: "#0B0F14", minHeight: "100vh" }}>
      <style>{`
